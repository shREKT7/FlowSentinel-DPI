# FlowSentinel – High-Performance Deep Packet Inspection Engine

FlowSentinel is a multi-threaded Deep Packet Inspection (DPI) engine written in modern C++ (C++17) that parses PCAP traffic, extracts TLS SNI and HTTP host headers, classifies applications (YouTube, Facebook, etc.), and applies flow-based blocking rules.

It simulates production-style ISP / enterprise DPI systems using a scalable architecture:

Reader → Load Balancers → FastPath Workers → Output Writer

---

## 🔑 Key Highlights

- Multi-threaded architecture with configurable scaling
- Flow tracking using 5-tuple hashing
- TLS Client Hello SNI extraction (HTTPS inspection)
- HTTP Host header extraction
- Flow-based blocking (IP, App, Domain)
- Thread-safe queues (producer-consumer model)
- Detailed traffic analytics & reporting
...
![Normal Run - Part 1](screenshots/normal_run_part1.png)
![Normal Run - Part 2](screenshots/normal_run_part2.png)

---

### YouTube Blocked Example

![YouTube Blocked - Part 1](screenshots/youtube_blocked_part1.png)
![YouTube Blocked - Part 2](screenshots/youtube_blocked_part2.png)

---

📌 This project demonstrates low-level networking, protocol parsing, concurrency design, and system-level performance architecture.

## Example Output

![Normal Run](screenshots/normal_run.png)
![YouTube Blocked](screenshots/youtube_blocked.png)
